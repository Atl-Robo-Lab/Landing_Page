...
const SolutionSection = () => {
  ...
  return (
    <section className="py-12 sm:py-16 md:py-24 relative overflow-hidden bg-gradient-to-br from-gray-900 via-slate-800 to-zinc-900 text-white" ref={ref}>
      {/* Modern Background */}
      <div className="absolute inset-0">
        ...
        <motion.div
          className="absolute top-10 sm:top-20 left-10 sm:left-20 w-32 sm:w-48 md:w-64 h-32 sm:h-48 md:h-64 bg-violet-500/15 rounded-full blur-3xl"
          animate={{
            scale: [1, 1.2, 1],
            opacity: [0.1, 0.2, 0.1]
          }}
        ...
        />
        <motion.div
          className="absolute bottom-10 sm:bottom-20 right-10 sm:right-20 w-40 sm:w-60 md:w-80 h-40 sm:h-60 md:h-80 bg-cyan-500/12 rounded-full blur-3xl"
          animate={{
            scale: [1.2, 1, 1.2],
      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        ...
        >
          ...
          <motion.p
            className="text-base sm:text-lg md:text-xl lg:text-2xl text-blue-100 max-w-4xl mx-auto px-4"
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
        ...
        >
          {solutions.map((solution, index) => (
            ...
            >
              {/* Background gradient */}
              <div className={`absolute inset-0 bg-gradient-to-br ${solution.bgColor} rounded-2xl sm:rounded-3xl opacity-20`}></div>
              ...
              <div className="relative bg-white/95 backdrop-blur-sm border border-white/20 rounded-2xl sm:rounded-3xl p-4 sm:p-6 md:p-8 shadow-xl hover:shadow-2xl transition-all duration-500 h-full">
                ...
                <div className="relative mb-4 sm:mb-6">
                  <motion.div
                    className={`w-14 h-14 sm:w-16 sm:h-16 md:w-20 md:h-20 rounded-2xl sm:rounded-3xl bg-gradient-to-br ${solution.gradient} flex items-center justify-center text-xl sm:text-2xl md:text-3xl shadow-lg`}
                    whileHover={{ 
                      scale: 1.1, 
                      rotate: [0, 5, -5, 0],
                  ...
                  {/* Floating decoration */}
                  <motion.div
                    className={`absolute -top-1 sm:-top-2 -right-1 sm:-right-2 w-4 h-4 sm:w-6 sm:h-6 rounded-full bg-gradient-to-r ${solution.gradient} opacity-30`}
                    animate={{
                      scale: [1, 1.2, 1],
                      opacity: [0.3, 0.6, 0.3]
                    }}
                ...
                >
                  {solution.features.map((feature, featureIndex) => (
                    <div key={featureIndex} className="flex items-center gap-2 sm:gap-3">
                      <div className={`w-1.5 h-1.5 sm:w-2 sm:h-2 rounded-full bg-gradient-to-r ${solution.gradient}`}></div>
                ...
                {/* Action button */}
                <motion.button
                  className={`w-full bg-gradient-to-r ${solution.gradient} text-white py-2.5 sm:py-3 px-4 sm:px-6 rounded-lg sm:rounded-xl font-semibold text-sm sm:text-base shadow-lg hover:shadow-xl transition-all duration-300`}
                  whileHover={{ 
                    scale: 1.02,
        ...
        >
          <motion.div
            className="bg-gradient-to-r from-orange-500 to-red-500 rounded-2xl sm:rounded-3xl p-6 sm:p-8 md:p-12 relative overflow-hidden"
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-sm sm:text-base md:text-lg lg:text-xl text-orange-100 mb-6 sm:mb-8 max-w-2xl mx-auto px-4">
              ...
              >
                <Link
                  to="/products"
                  className="inline-block bg-white text-orange-600 px-6 sm:px-8 md:px-10 py-3 sm:py-4 rounded-lg sm:rounded-xl font-bold text-sm sm:text-base md:text-lg shadow-xl hover:shadow-2xl transition-all duration-300"
                >
